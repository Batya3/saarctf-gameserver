...
base_dir = '/opt/gameserver'

# Update possible config files list to include the new path
possible_config_files = [
    os.path.join(base_dir, 'config_test.json'),
    os.path.join(base_dir, 'config2.json'),
...
VPN_BASE_DIR = os.path.join(base_dir, 'vpn')
CLOUDCONFIG_FILE = os.path.join(base_dir, 'cloud-status.json')
